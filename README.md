...
- && is the synonymous to and in python
- body of function is inside curly braces
- System.out.println() is the same as print() function in python
- if statement conditions are written inside brackets
- for loop conditions are writen inside brackets
